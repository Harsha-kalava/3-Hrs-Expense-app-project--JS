...
function btnClicked(e){
    ...
    async function postRequest (){
        try{
            const resp = await axios.post("https://crudcrud.com/api/9a55f99f33cb4342b72243efc7cb7677/expenseDetails",obj)
...
async function updatebtn(dataId){
    try{
        ...
        .put(
            `https://crudcrud.com/api/9a55f99f33cb4342b72243efc7cb7677/expenseDetails/${dataId}`,
            {
...
async function deleteUser(userID) {
    try{const deletefun = await axios.delete(`https://crudcrud.com/api/9a55f99f33cb4342b72243efc7cb7677/expenseDetails/${userID}`)
        removeUser(userID)
        }catch(err){
			console.log(err);
		};		
...
window.addEventListener("DOMContentLoaded", async function(){
    try{
        const onDomLoad = await axios.get("https://crudcrud.com/api/9a55f99f33cb4342b72243efc7cb7677/expenseDetails")
